          ...
          questions: [
            {
              ...
              choices: [
                'A mathematical formula that maps inputs to desired outputs',
                'A database of memorized answers to look up later',
                'A set of hand-written rules provided by experts',
                'A copy of the training data, compressed',
              ],
              answer: 0,
              explain:
                'Training finds a formula (a model) that reproduces the desired outputs on training data — and, if all goes well, on new data from the same distribution.',
            },
            {
              kind: 'tf',
              id: 'ch01-q-what-2',
          ...
          questions: [
            {
              ...
              choices: [
                ...
                'The labels are real numbers rather than classes',
                'There is no dataset, only rewards',
                'The model outputs clusters instead of labels',
              ],
              answer: 0,
              explain:
                'Same goal as supervised learning — predict labels — but the algorithm can also exploit a (usually much larger) pool of unlabeled examples.',
            },
            {
              kind: 'match',
              id: 'ch01-q-types-2',
            ...
            },
            {
              ...
              choices: [
                'Grouping news articles by topic when no topics were assigned',
                'Predicting tomorrow’s temperature from past labeled records',
                'Learning to play backgammon from win/lose feedback',
                'Diagnosing X-rays from a database of doctor-labeled scans',
              ],
              answer: 0,
              explain:
                'No labels were given, and the structure (topic groups) must be found by the algorithm — that is clustering.',
            },
          ],
        },
      ],
          ...
          questions: [
            {
              ...
              choices: [
                'Turns each text message into a fixed-length numeric feature vector',
                'Removes spam words from the messages',
                'Compresses the dataset to save memory',
                'Assigns the +1/−1 labels automatically',
              ],
              answer: 0,
              explain:
                'Learning algorithms need numbers: each message becomes a 20,000-dimensional 0/1 vector recording which dictionary words appear.',
            },
            {
              kind: 'mcq',
              id: 'ch01-q-svm-2',
              ...
              choices: [
                'the sign of $\\mathbf{w}^*\\mathbf{x} - b^*$',
                'the distance to the nearest training message',
                'the average label of all training data',
                'the number of spam words it contains',
              ],
              answer: 0,
              explain:
                'The model is $f(\\mathbf{x}) = \\mathrm{sign}(\\mathbf{w}^*\\mathbf{x} - b^*)$: positive side means spam (+1), negative side means not_spam (−1).',
            },
            {
              kind: 'mcq',
              id: 'ch01-q-svm-3',
              ...
              choices: [
                'It generalizes better: new points are less likely to fall on the wrong side',
              ...
              answer: 0,
              explain:
                'A boundary far from both classes tolerates the natural scatter of future examples — that distance-buying is generalization.',
            },
            {
              kind: 'tf',
              id: 'ch01-q-svm-4',
          ...
          questions: [
            {
              ...
              choices: [
                'New examples come from the same distribution, drawn independently at random',
                'The model has enough parameters to memorize the training set',
                'The training data was cleaned by human experts',
                'The algorithm ran until training error reached zero',
              ],
              answer: 0,
              explain:
                'Same-distribution, independent sampling makes new points land near old ones of the same class — the whole basis of generalization.',
            },
            {
              kind: 'tf',
              id: 'ch01-q-why-2',
            ...
            },
            {
              ...
              choices: [
                'make new examples less likely to be unlike anything seen in training',
                'increase the number of errors on new data',
                'make the margin irrelevant',
                'change the true data distribution',
              ],
              answer: 0,
              explain:
                'More independent samples cover the distribution better, shrinking the surprise factor of future data.',
            },
          ],
        },
      ],
  ...
  bossPool: [
    {
      ...
      choices: [
        'fail when inputs come from a distorted or shifted distribution',
        'cannot store more than a few examples',
        'require labels for every input forever',
        'never make correct predictions on new data',
      ],
      answer: 0,
      explain:
        'Slightly distort the inputs (rotate the screen) and the “learned” skill collapses — unlike animal learning.',
    },
    {
      kind: 'mcq',
      id: 'ch01-boss-2',
      ...
      answer: 0,
      explain: 'Arthur Samuel at IBM, 1959 — partly as attractive branding for clients and talent.',
    },
    {
      kind: 'match',
      id: 'ch01-boss-3',
    ...
    },
    {
      ...
      choices: [
        'Managing a warehouse robot that gets rewarded for fast, safe deliveries',
        'Predicting apartment prices from labeled sales records',
        'Grouping unlabeled songs by acoustic similarity',
        'Classifying reviews as positive or negative using labeled reviews',
      ],
      answer: 0,
      explain: 'Sequential actions in an environment with rewards — the reinforcement setting.',
    },
    {
      kind: 'mcq',
      id: 'ch01-boss-6',
      ...
      choices: [
        ...
        'a list of its misspelled words',
        'a 2-dimensional point (words, characters)',
    ...
    },
    {
      ...
      choices: [
        ...
        'a decision tree of if-then rules',
      ],
      answer: 0,
      explain: 'Training finds $\\mathbf{w}^*, b^*$; prediction is $\\mathrm{sign}(\\mathbf{w}^*\\mathbf{x} - b^*)$.',
    },
    {
      kind: 'tf',
      id: 'ch01-boss-8',
    ...
    },
    {
      ...
      choices: [
        'the distance between the boundary and the closest examples of each class',
        'the number of misclassified points',
        'the length of the weight vector',
        'the number of features used',
      ],
      answer: 0,
      explain: 'SVM picks, among all separating boundaries, the one that maximizes this distance.',
    },
    {
      kind: 'numeric',
      id: 'ch01-boss-10',
    ...
    },
    {
      ...
      choices: [
        'reveal more about the underlying data distribution and improve the model',
      ...
      answer: 0,
      explain:
        'A larger sample reflects the source distribution better, and a good algorithm can leverage that structure.',
    },
    {
      kind: 'mcq',
      id: 'ch01-boss-12',
      ...
      choices: [
        ...
        'color of the plots and size of the paper',
        'number of authors and year of invention',
        'amount of RAM and disk space used during download',
      ],
      answer: 0,
      explain:
        'In practice you often trade a bit of accuracy for a model that trains fast or predicts fast.',
    },
    {
      kind: 'tf',
      id: 'ch01-boss-13',
    ...
    },
    {
      ...
      choices: [
        'model error, training-set size, model-equation form, and training time',
        'CPUs, GPUs, and cloud pricing',
        'Python, R, and Julia',
        'the number of classes and the number of clusters',
      ],
      answer: 0,
      explain: '“Probably approximately correct”: when will a learner probably output an approximately correct classifier?',
    },
    {
      kind: 'mcq',
      id: 'ch01-boss-15',
      prompt: 'A dataset of customer profiles with *no* labels needs segmenting into groups. The right tool is…',
      choices: ['clustering', 'linear regression', 'a policy', 'bag of words'],
      answer: 0,
      explain: 'Unlabeled + grouping = clustering, the flagship unsupervised task.',
    },
    {
      kind: 'tf',
      id: 'ch01-boss-16',
    ...
    },
    {
      ...
      choices: [
        'a version with a penalty hyperparameter for misclassifications',
        'deleting the training data',
        'switching to unsupervised learning',
        'adding more dictionary words',
      ],
      answer: 0,
      explain: 'The soft-margin SVM tolerates some misclassified points in exchange for a wider, more robust margin.',
    },
    {
      kind: 'order',
      id: 'ch01-boss-18',
