...
export const conceptsCh04: Concept[] = [
  ...
  },
  {
    ...
    technical:
      'One change to [[adagrad]]: replace the ever-growing sum with an exponentially decaying average of the squared gradients. The per-parameter scaling survives, the terminal slowdown does not. This matters most on non-convex problems, where the curvature the optimizer faces at epoch 50 has nothing to do with what it faced at epoch 1 and a decision made early should not still be binding. Hinton proposed it on a lecture slide and never published it formally, which did not stop it being the default for recurrent networks for years.',
    math:
